use fil_actor_multisig_state_v8::testing::check_state_invariants;
use fil_actor_multisig_state_v8::{
...
mod vesting_tests {
    ...
    fn happy_path_full_vesting() {
        ...
        let proposal_hash = h.propose_ok(
            &mut rt,
            DARLENE,
            TokenAmount::from_atto(MSIG_INITIAL_BALANCE),
            METHOD_SEND,
            RawBytes::default(),
        );
    ...
    fn partial_vesting_propose_to_send_half_the_actor_balance_when_the_epoch_is_half_the_unlock_duration(
        ...
        let proposal_hash = h.propose_ok(
            &mut rt,
            DARLENE,
            TokenAmount::from_atto(MSIG_INITIAL_BALANCE / 2),
            METHOD_SEND,
            RawBytes::default(),
        );
    ...
    fn propose_and_autoapprove_tx_above_locked_amount_fails() {
        ...
        let amount_out = TokenAmount::from_atto(MSIG_INITIAL_BALANCE / 10);
        rt.expect_send(
            DARLENE,
            METHOD_SEND,
            RawBytes::default(),
