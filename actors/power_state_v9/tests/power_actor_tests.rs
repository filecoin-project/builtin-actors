use fil_actor_power_state_v9::ext::init::{ExecParams, EXEC_METHOD};
...
mod cron_tests {
    ...
    use fil_actor_power_state_v9::ext::reward::Method as RewardMethod;
    use fil_actor_power_state_v9::ext::{
