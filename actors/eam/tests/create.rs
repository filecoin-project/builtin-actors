...
use eam::{CreateParams, EamReturn, EvmConstructorParams, RlpCreateAddress, Create2Params};
...
fn call_create2() {
    ...
    let mut subaddress =
        rt.hash(fvm_shared::crypto::hash::SupportedHashes::Keccak256, &[&[0xff], &eth_addr.0[..], &create2_params.salt, &inithash].concat());
    subaddress.drain(..12);
