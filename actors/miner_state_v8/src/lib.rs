...
use fil_actors_runtime_common::runtime::{
    builtins::Type, ActorCode, DomainSeparationTag, Policy, Runtime,
};
...
impl Actor {
        ...
        RT: Runtime,
    {
        ...
        let mut fee_to_burn = TokenAmount::from_atto(0_u32);
...
fn get_verify_info<RT>(rt: &mut RT, params: SealVerifyParams) -> Result<SealVerifyInfo, ActorError>
where
    RT: Runtime,
{
...
fn request_unsealed_sector_cids<RT>(
    rt: &mut RT,
