...
mod construction {
    ...
    use fil_actor_verifreg_state_v9::{Actor as VerifregActor, Method};
...
mod verifiers {
    ...
    use fil_actor_verifreg_state_v9::{Actor as VerifregActor, AddVerifierParams, DataCap, Method};
    use fil_actors_runtime_common::test_utils::*;
    use harness::*;
    use util::*;
...
mod clients {
    ...
    use fil_actor_verifreg_state_v9::{
...
mod allocs_claims {
    ...
    use fil_actor_verifreg_state_v9::Claim;
    use fil_actor_verifreg_state_v9::{
        AllocationID, ClaimTerm, DataCap, ExtendClaimTermsParams, State,
    };
...
mod datacap {
    ...
    use fil_actor_verifreg_state_v9::{Actor as VerifregActor, Claim, Method, State};
