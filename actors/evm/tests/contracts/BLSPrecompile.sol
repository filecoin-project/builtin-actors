...
contract BLSPrecompileCheck {
    ...
    function testG2AddFailure() public view {
        // Input with invalid G2 point (not on curve)
        ...
        // Call precompile, expecting failure
        (bool success, bytes memory output) = G2_ADD_PRECOMPILE.staticcall(invalidInput);
    ...
    function testG1MSMFailure() public view {
        // Invalid input: zero number of points but with point data
        bytes memory invalidInput = hex"";
        
        // Call precompile, expecting failure
        (bool success, bytes memory output) = G1_MSM_PRECOMPILE.staticcall(invalidInput);
    ...
    function testG2MSMFailure() public view {
        ...
        // Call precompile, expecting failure
        (bool success, bytes memory output) = G2_MSM_PRECOMPILE.staticcall(invalidInput);
    ...
    function testMapFpToG1Failure() public view {
        // Input with invalid length (too short)
        ...
        // Call precompile, expecting failure
        (bool success, bytes memory output) = MAP_FP_TO_G1_PRECOMPILE.staticcall(invalidInput);
    ...
    function testMapFp2ToG2Failure() public view {
        ...
        // Call precompile, expecting failure
        (bool success, bytes memory output) = MAP_FP2_TO_G2_PRECOMPILE.staticcall(invalidInput);
    ...
    function testPairingFailure() public view {
        // Input with invalid length (not a multiple of 384)
        bytes memory invalidInput = hex""; // Only 128 bytes (G1 point)
        
        // Call precompile, expecting failure
        (bool success, bytes memory output) = PAIRING_CHECK_PRECOMPILE.staticcall(invalidInput);
