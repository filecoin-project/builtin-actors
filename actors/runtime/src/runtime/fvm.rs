...
use crate::runtime::{
    ActorCode, ConsensusFault, DomainSeparationTag, MessageInfo, Policy, RuntimePolicy, Syscalls,
};
use crate::{
    ...
    B: Blockstore,
{
    ...
    fn send(
        ...
        if self.in_transaction {
            return Err(ActorError::new(SYS_ILLEGAL_ACTOR, "runtime.send() is not allowed".into()));
        }
