    ...
    BS: Blockstore,
{
    ...
    /// Adds key to the set.
    #[inline]
    pub fn put(&mut self, key: BytesKey) -> Result<(), Error<BS::Error>> {
    ...
    #[inline]
    pub fn has(&self, key: &[u8]) -> Result<bool, Error<BS::Error>> {
        self.0.contains_key(key)
    }

    /// Deletes key from set.
    #[inline]
    pub fn delete(&mut self, key: &[u8]) -> Result<Option<()>, Error<BS::Error>> {
    ...
    pub fn collect_keys(&self) -> Result<Vec<BytesKey>, Error<BS::Error>> {
