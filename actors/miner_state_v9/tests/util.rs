...
use fil_actor_account_state_v9::Method as AccountMethod;
...
use fil_actor_miner_state_v9::ext::market::ON_MINER_SECTORS_TERMINATE_METHOD;
use fil_actor_miner_state_v9::ext::power::{
    UPDATE_CLAIMED_POWER_METHOD, UPDATE_PLEDGE_TOTAL_METHOD,
};
use fil_actor_miner_state_v9::ext::verifreg::{
...
use fil_actor_miner_state_v9::{Method as MinerMethod, ProveCommitAggregateParams};
use fil_actor_power_state_v9::{
    CurrentTotalPowerReturn, EnrollCronEventParams, Method as PowerMethod, UpdateClaimedPowerParams,
};
use fil_actor_reward_state_v9::{Method as RewardMethod, ThisEpochRewardReturn};
...
use fil_actor_miner_state_v9::testing::{
    ...
    pub fn extend_sectors2(
        ...
        for extension in params.extensions.iter_mut() {
            for sc in &extension.sectors_with_claims {
                ...
                rt.expect_send(
                    VERIFIED_REGISTRY_ACTOR_ADDR,
                    fil_actor_miner_state_v9::ext::verifreg::GET_CLAIMS_METHOD as u64,
