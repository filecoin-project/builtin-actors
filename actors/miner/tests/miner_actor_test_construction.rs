...
use fil_actor_miner::{Actor, State, MinerConstructorParams as ConstructorParams, Method,
                      Deadlines, Deadline,
...
fn simple_construction() {
    ...
    let result = env.rt.call::<Actor>(Method::Constructor as u64, &RawBytes::serialize(params).unwrap()).unwrap();
