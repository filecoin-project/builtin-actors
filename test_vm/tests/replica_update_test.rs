...
use fil_actor_miner::{
    power_for_sector, Method as MethodsMiner, ProveCommitSectorParams, ProveReplicaUpdatesParams,
    ReplicaUpdate, SectorOnChainInfo, State as MinerState,
};
...
use fil_actors_runtime::{
    CRON_ACTOR_ADDR, EPOCHS_IN_DAY, STORAGE_MARKET_ACTOR_ADDR, SYSTEM_ACTOR_ADDR,
};
...
use test_vm::util::{
    ...
    precommit_sectors, publish_deal, sector_info, submit_windowed_post,
};
use test_vm::VM;
